...
export default function Error({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1e2938]">
        ...
        <div className="text-center">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 bg-white border-2 border-gray-200 text-gray-700 font-medium rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
            >
              Voltar ao login
            </button>
          </div>
