...
export default function MainPage() {
   ...
   <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-blue-900/10 via-transparent to-transparent"></div> */}
            ...
            <div className="relative z-10 flex-1 flex flex-col">
                <div className={`flex-initial space-y-5 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8 justify-center items-center'
                    }`}>
