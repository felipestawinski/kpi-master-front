...
export function ProfilePage() {
 ...
 if (!user) {
  return (
   <div className="flex items-center justify-center min-h-screen">
    <div className="text-center backdrop-blur-xl bg-red-500/20 rounded-2xl p-8 ">
      ...
      <div className="flex-1 w-full space-y-4">
       ...
       <div className="flex flex-col sm:flex-row gap-3">
        <label className="flex-1 cursor-pointer">
         <div className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 flex items-center justify-center space-x-2">
       ...
       {file && (
        <div className="fade-in p-3 rounded-xl bg-white/5 backdrop-blur-sm">
...
function InfoCard({ 
 ...
 return (
  <div className={`backdrop-blur-sm bg-white/5 rounded-xl p-5 hover:bg-white/10 hover:border-amber-400/30 transition-all duration-300 group ${colSpan ? 'md:col-span-2' : ''}`}>
